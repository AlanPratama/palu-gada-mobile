...
export default function BottomSheetAddReview({ refRBSheet }) {
  return (
    <View>
        <RBSheet
        ref={refRBSheet}
        ...
        openDuration={250}
      >
        <AddReviewComp refRBSheet={refRBSheet} />
      </RBSheet>
    </View>
  )
}
...
const AddReviewComp = ({ refRBSheet }) => {
        ...
        <View style={{ marginTop: 26 }}>
          <View style={{ paddingHorizontal: 18, marginBottom: 25 }}>
            ...
            <Controller
              control={control}
              rules={{
                required: "Rating wajib diisi!", validate: (value) => value >= 1 && value <= 5 || `Rating harus diantara 1 hingga 5`
              }}
