    ...
    <KeyboardAwareScrollView>
      <View className="justify-start items-center min-h-screen">
        ...
        <Animated.View
          ...
          className="bg-white rounded-t-[35px] h-full w-full px-8 pt-12"
        >
          ...
          {errors.credential && (
            <Text style={{ color: "red" }}>{errors.credential.message}</Text>
          )}
          ...
          <TouchableOpacity
            ...
            className="bg-[#4f6def] py-2 rounded-full w-full mt-6"
          >
          ...
          <View className="flex-row justify-center items-center mt-4">
            <Text className="text-center text-[#404040]">
              Belum punya akun?{" "}
            </Text>
            <TouchableOpacity onPress={() => navigate.push("Register")}>
              <Text className="text-center text-[#4f6def] font-semibold">
                Register
              </Text>
            </TouchableOpacity>
          </View>
