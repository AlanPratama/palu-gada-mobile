    ...
    <View className="justify-start items-center min-h-screen">
      ...
      <Animated.View entering={FadeInDown.delay(50)} className="bg-white rounded-t-[35px] h-full w-full px-8 pt-12">
        ...
        <View className="flex-row justify-start items-center w-full mb-4">
          ...
          <TextInput className="border-b-2 border-[#d1d1d1] text-[#303030] ml-2 py-2 w-[90%]" placeholder='Masukkan Username atau Email' />
        </View>
        ...
        <View className="flex-row justify-center items-center mt-4">
          ...
          <TouchableOpacity onPress={() => navigate.push("Register")}><Text className="text-center text-[#4f6def] font-semibold">Register</Text></TouchableOpacity>
        </View>
      </Animated.View>
    </View>
  )
