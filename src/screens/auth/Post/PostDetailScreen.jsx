...
export default function PostDetailScreen({ route }) {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} className='min-h-screen bg-white'>
      <View className='border-b border-gray-300 flex-row justify-between items-center p-3'>
        <View className='flex-row justify-start items-center gap-x-2'>
          <TouchableOpacity onPress={() => navigate.goBack()} activeOpacity={0.5} className='flex-row justify-start items-center'>
            <Ionicons name='chevron-back' size={24} color='black' />
            <Text className='text-xl text-[#343434] font-semibold ml-1'>Kembali</Text>
          </TouchableOpacity>
        </View>
        <TouchableOpacity
      ...
      <View className='p-3'>
        ...
        <View className='mt-3 flex-row justify-start items-center'>
          <Text className='text-[17px] font-medium text-[#343434]'>Bayaran: </Text>
          <Text className='text-[17px] font-normal text-[#343434]'>Rp 250.000 - 500.000</Text>
        </View>

        <View className='mt-1.5 flex-row justify-start items-center'>
          <Text className='text-[17px] font-medium text-[#343434]'>Tenggat Pilih Pekerja: </Text>
          <Text className='text-[17px] font-normal text-[#343434]'>1 Hari</Text>
        </View>

        <View className='flex-row justify-evenly items-center mt-6'>
          <TouchableOpacity activeOpacity={0.7} className='flex-row justify-center items-center gap-x-2'>
            <Ionicons name='information-circle-outline' size={24} color='#343434' />
            <Text>Tersedia</Text>
          </TouchableOpacity>
        ...
        <View className='mt-6'>
          ...
          >
            <Text className='text-base text-white text-center font-semibold'>Tambah Penawaran</Text>
          </TouchableOpacity>
        </View>

        <View className='mt-6'>
          <Text className='mb-3 text-[18px] font-medium text-[#343434]'>Penawar Saat Ini</Text>
        ...
        <View className='mt-6'>
          <Text className='mb-3 text-[18px] font-medium text-[#343434]'>Pemilik</Text>
          <View className='flex-row justify-start items-start gap-x-3.5'>
            ...
            />
            <View className=''>
              <Text className='text-base font-medium text-[#343434]'>Alan Pratama</Text>
            </View>
          </View>
        </View>
      </View>
